...
function scheduler_activate() {
	...
	if (!$stable_config_row) {
		$query = "INSERT INTO ".$config->prefix."options VALUES (null, 0, 'scheduler_stable_config', '".$config->default_xml."', 'yes')";
		$wpdb->query($query);
	}
...
function set_default_options() {
	global $wpdb, $config;
	$query = "INSERT INTO ".$config->prefix."options VALUES (null, 0, 'scheduler_php', '', 'yes')";
	$wpdb->query($query);
	$query = "INSERT INTO ".$config->prefix."options VALUES (null, 0, 'scheduler_xml', '".$config->default_xml."', 'yes')";
	$wpdb->query($query);
	$query = "INSERT INTO ".$config->prefix."options VALUES (null, 0, 'scheduler_php_version', '0', 'yes')";
	$wpdb->query($query);
	$query = "INSERT INTO ".$config->prefix."options VALUES (null, 0, 'scheduler_xml_version', '1', 'yes')";
	$wpdb->query($query);
	$query = "INSERT INTO ".$config->prefix."options VALUES (null, 0, 'scheduler_num', '5', 'yes')";
	$wpdb->query($query);
	$query = "INSERT INTO ".$config->prefix."options VALUES (null, 0, 'scheduler_url', '', 'yes')";
	$wpdb->query($query);
	$query = "INSERT INTO ".$config->prefix."options VALUES (null, 0, 'scheduler_stable_config', '".$config->default_xml."', 'yes')";
	$wpdb->query($query);
}
