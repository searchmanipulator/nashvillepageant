...
echo "<table width=1000><tr><th>Record ID</th><th>Registration Date</th><th>First Name</th><th>Last Name</th><th>Email</th><th>Registration Code</th></tr>";
foreach ($regdetail as $reg) {
	echo "<tr><td>" . $reg->id . "</td><td>" . $reg->time . "</td><td>" . $reg->fname . "</td><td>" . $reg->lname . "</td><td>" . $reg->email . "</td><td>" . $reg->rcode . "</td></tr>";
}
echo "</table>";
