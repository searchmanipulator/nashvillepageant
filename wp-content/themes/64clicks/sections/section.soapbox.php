								...
								<div class="soapbox-links">
									<?php for( $i = 1; $i <= 3; $i++):?>
											<?php if(get_post_meta($post->ID, '_soapbox_link_'.$i, true)):
												$link_text = ( get_pagelines_meta('_soapbox_link_'.$i.'_text', $post->ID) ) ? get_pagelines_meta('_soapbox_link_'.$i.'_text', $post->ID) : $soapbox_link_text[$i]; 
												$link_class = ( get_pagelines_meta('_soapbox_link_'.$i.'_class', $post->ID) ) ? get_pagelines_meta('_soapbox_link_'.$i.'_class', $post->ID) : $soapbox_link_text[$i]; 
											?>
