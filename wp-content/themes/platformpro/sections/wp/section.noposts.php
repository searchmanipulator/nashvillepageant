...
class PageLinesNoPosts extends PageLinesSection {
   ...
   function section_template() { ?>
	...
	<?php else: ?>
				...
				<p class="subhead center"><?php _e('Sorry, This Page Does not exist.', 'pagelines');?><br/><?php _e('Go','pagelines');?> <a href="<?php echo get_option('home'); ?>"><?php _e('home','pagelines');?></a> <?php _e('or try a search?', 'pagelines');?></p>
